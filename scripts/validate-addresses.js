...
async function main() {
  // First batch of addresses from the actual distribute-tokens.js file
  const distribution = [
    [
      // --- TEAM 5% ---
      { address: "0x768bBDAE55D43C780eD157f6C719d2F00c5A9E2B", amount: "88000000", category: "TEAM 5%", vesting: "NO VESTING" },
      { address: "0xa137F52f96f124471d146cc36940c23935117f62", amount: "112000000", category: "TEAM 5%", vesting: "VESTED 3M" },
      { address: "0xEd7c2962b4f3B3D129Eb4DC4fdd8487E903Dd66d", amount: "83000000", category: "TEAM 5%", vesting: "VESTED 3M" },
      { address: "0x80358cB739e09E900EE04abD64aA1a8a3C6C558E", amount: "121000000", category: "TEAM 5%", vesting: "VESTED 3M" },
      { address: "0x042d0666b9258801c9bDBF7BF8D8520E0A4EbB24", amount: "96000000", category: "TEAM 5%", vesting: "VESTED 3M" },
    
      // --- TWx ---
      { address: "0x6D478dcA46a1EF30553BC324F27665F7F464B529", amount: "77257400", category: "TW1", vesting: "" },
      { address: "0x2492fDA5F5F98D8679A90858baf011e0CB7AF427", amount: "82435400", category: "TW2", vesting: "" },
      { address: "0x030a94A22a7AD7863faF33D0f9D252106DF10664", amount: "82547810", category: "TW3", vesting: "" },
      { address: "0xC5eE20131B0fF69bC8fF66aE8b15Fc44E04f2334", amount: "114456310", category: "TW4", vesting: "" },
      { address: "0xAe82E3929dF0BFfBe974444A357209A4f287333d", amount: "63145870", category: "TW5", vesting: "" },
      { address: "0x3cb7fb96C13d0F26032D492f49DD873A790310fB", amount: "71478540", category: "TW6", vesting: "" },
      { address: "0x173F1c6Ab0Ec507bc3571736926083B1D974b680", amount: "93558960", category: "TW7", vesting: "" },
      { address: "0x05749ce20C8682438580c011e5104884C3b4192a", amount: "84784120", category: "TW8", vesting: "" },
      { address: "0xBd937e1b4C8dA2090452A0053cc669cC6F6ca0D5", amount: "72563210", category: "TW9", vesting: "" },
      { address: "0x3DDC1CB46DAb13cD8a173214a8525efe80C84F0f", amount: "101612500", category: "TW10", vesting: "" },
      { address: "0xd4C8EC619DA2A9902288Fd065dcC29C4DacE59E4", amount: "122554010", category: "TW11", vesting: "" },
      { address: "0xC5B9dfA6560d0E4652402D08ADA21FF35C3041BE", amount: "146440610", category: "TW12", vesting: "" },
      { address: "0x3a47CA92e62389133Afd5261F61bfb7936ba5d2d", amount: "59785200", category: "TW13", vesting: "" },
      { address: "0x5A7484B32F416C95213C0b89F6A32199be830A6F", amount: "73021450", category: "TW14", vesting: "" },
      { address: "0x59FF3e1A4C7a0e1813EF88084eC2cb48719a2cE1", amount: "84352100", category: "TW15", vesting: "" },
  ...
  console.log("The following addresses need correction to be valid Ethereum addresses:\n");
  ...
  for (const item of distribution) {
    ...
    if (isValidEthereumAddress(formattedAddress)) {
      validCount++;
      console.log(`✅ VALID: ${item.address}`);
      console.log(`   Category: ${item.category}, Amount: ${item.amount}, Vesting: ${item.vesting || 'None'}`);
      console.log("");
    } else {
      invalidCount++;
      ...
      // Try to provide some guidance on possible issues
  ...
  console.log(`\nValidation complete: ${validCount} valid addresses, ${invalidCount} invalid addresses`);
  
  if (invalidCount > 0) {
    console.log("\nIMPORTANT: You need to correct the invalid addresses before distribution");
    console.log("Valid Ethereum addresses are 42 characters (including '0x') and contain only hexadecimal characters (0-9, a-f, A-F)");
  } else {
    console.log("\nAll addresses are valid! You can proceed with distribution.");
  }
}
